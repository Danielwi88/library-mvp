  ...
  return (
    <div className='mx-auto max-w-[400px] space-y-6 py-10'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
        <div>
          <Label htmlFor='name' className='font-bold pb-2 text-sm'>
            Name
          </Label>
          <Input
            id='name'
        ...
        <div>
          <Label htmlFor='email' className='font-bold pb-1 text-sm'>
            Email
          </Label>
          <Input
            id='email'
        ...
        <div>
          <Label htmlFor='phone' className='font-bold pb-1 text-sm'>
            Nomor Handphone
          </Label>
          <Input
            id='phone'
        ...
        <div>
          <Label htmlFor='password' className='font-bold pb-1 text-sm'>
            Password
          </Label>
        ...
        <div>
          <Label htmlFor='confirmPassword' className='font-bold pb-1 text-sm'>
            Confirm Password
          </Label>
      ...
      <p className='text-sm sm:text-md font-semibold text-center'>
        ...
        <Link to='/login' className='text-primary-300'>
          Log In
        </Link>
      </p>
    </div>
